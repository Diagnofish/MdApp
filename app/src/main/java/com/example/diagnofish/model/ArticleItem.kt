...
val dummyArticleItems = arrayOf(
    ArticleItem(R.drawable.blank_image, "Bacterial diseases - Aeromoniasis", "Penyakit bakterial, terutama Aeromoniasis yang disebabkan oleh bakteri Aeromonas hydrophila, merupakan ancaman serius bagi pembudidaya ikan air tawar. Artikel ini bertujuan memberikan pemahaman mendalam tentang penyakit ini, serta memberikan solusi pencegahan dan pengobatan yang efektif.\n" +
    ...
    ArticleItem(R.drawable.blank_image, "Bacterial gill disease", "Penyakit insang bakterial, atau Bacterial Gill Disease (BGD), umumnya disebabkan oleh bakteri filamen dalam genus Flavobacterium, terutama F. branchiophilum. Penyakit ini menyebabkan pembengkakan lembaran insang, mengurangi pertukaran gas untuk pernapasan ikan. Artikel ini akan membahas gejala, pencegahan, dan pengobatan penyakit ini.\n" +
            "\n" +
            "Gejala\n" +
    ...
    ArticleItem(R.drawable.blank_image, "Fish Fin Rot", "Ikan peliharaan yang mengalami penyakit busuk sirip (Fish Fin Rot) seringkali menunjukkan gejala seperti sirip robek dan kusam, baik pada sirip maupun ekor. Tepi sirip juga dapat menunjukkan perubahan warna yang tidak normal, terkadang lebih terang atau lebih gelap. Jika tidak diobati, kondisi ini dapat menyebabkan kerusakan lebih lanjut pada sirip dan menyebabkan infeksi menyebar ke seluruh tubuh ikan.\n" +
