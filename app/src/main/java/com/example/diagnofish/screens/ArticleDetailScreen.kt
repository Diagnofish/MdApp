...
fun ArticleDetailScreen(
    ...
    Scaffold(topBar = {
        ...
        Column(
            ...
            Image(painter = painterResource(id = articleItem.image), contentDescription = stringResource(
                id = articleItem.title), modifier = Modifier.fillMaxWidth(), contentScale = ContentScale.Crop
            )
            SectionTitle(text = stringResource(articleItem.title))
            BasicText(text = stringResource(id = articleItem.content), textAlign = TextAlign.Justify)
        }
    }
}